module.exports = {
  ...
  name: "tienganh",
  code: `$description[Học tiếng anh và nói được từ $randomText[Hello;Hi;What;I love you cô Thảo;Where's are you from; Welcome to RoomRoom;],Bạn được cô giáo Thảo cho **$random[0;1] hộp quà.** \`$getServerVar[prefix]hopqua\` để mở hộp quà lấy 5 điểm.]
$color[$random[0;999999]]
$setGlobalUserVar[tienganh;$sum[$getGlobalUserVar[tienganh];$random[0;1]]]
